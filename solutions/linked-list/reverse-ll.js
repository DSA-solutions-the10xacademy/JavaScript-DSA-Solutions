...
function reverse_llist(llist){
    ...
    while(currentNode){
        ...
        // linking current node's pointer to previous node
        currentNode.next = prevNode;
        // updating the value of previous node
        prevNode = currentNode;
        // updating the value of current node
        currentNode = nextNode;
    }

    // assinging previous as head because 
    // the last encountered node will be the head of the reversed linked list
    llist.head = prevNode;
}
